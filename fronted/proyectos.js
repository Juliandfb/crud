            ...
            data.proyectos.forEach(proyecto => {
                const row = `
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-info" onclick="verDetalles(${proyecto.id_proyecto})">Ver Detalles</button>
                            <button class="btn btn-danger" onclick="eliminarProyecto(${proyecto.id_proyecto})">Eliminar</button>
                        </td>
                    </tr>
                `;
                tabla.innerHTML += row;
